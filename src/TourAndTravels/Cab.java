...
public class Cab extends javax.swing.JFrame {
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(sbname)
                                    .addComponent(sbtime, javax.swing.GroupLayout.DEFAULT_SIZE, 145, Short.MAX_VALUE))
                                .addGap(73, 73, 73))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(80, 80, 80)
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
                ...
                if(nme.trim().isEmpty())
                    ...
                    Acknow.setText("Please Fill the 'Contact' fieldProperly.");
                    ...
                    Acknow.setText("Please Fill the 'no of passenger' field.");
...
//                    String sql = "INSERT INTO bus(nme,contact,eml,frm,t,jdate,bname,boardtime,np,price) VALUES('"+nme+"','"+contact+"','"+eml+"','"+frm+"','"+t+"','"+jdate+"','"+bname+"','"+boardtime+"','"+np+"','"+price+"') ; ";
                    String sql = "insert into cab(nme,ctct,eml,frm,t,jdate,cname,boardtime,np,price) values(?,?,?,?,?,?,?,?,?,?)";
